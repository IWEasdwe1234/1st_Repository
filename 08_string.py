...
# SQE-00Q8이라는 설비의 SQE만뽑아내기 (find와 슬라이싱 사용)
sqe = "SQE-00Q8"
...
"str".startswith("s")
# 123.startswith(1)
# .으로 사용하는 매서드들은 특정 자료형(객체 타입)마다 다름
# int 자료형의 객체에는 startswith라는 매서드가 없음
...
# sep속성을 사용하면 구분을 공백이 아닌 특정 문자열로 가능
...
print("안녕", "하세", end="요" + "ㅎㅎ\n")  # 정상 동작 (사용 자제)

# 기본적으로 print문에는 sep으로 공백 한칸,
# end로 \n(줄바꿈)이 적용되어 있음
# 근데, 개발자가 각 속성을 직접 부여할 경우
# 기본값이 아닌 전달받은 속성 값을 사용
